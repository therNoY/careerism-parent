package pers.mihao.careerism.java.base.encryption;
...
public class RSACoder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = "我是甲方 只有我能发";
        System.out.println("===========甲方向乙方发送数据 进行数字签名==============");
        System.out.println("原文:" + str);
        //甲方用自己的私钥对数据的加密
        byte[] code1 = RSACoder.encryptByPrivateKey(str.getBytes(), publicKey);
        System.out.println("甲方 使用自己私钥加密后的数据：" + Base64.encode(code1));
