 ...
 */
public class Code122买卖股票问题2 {

    public static void main(String[] args) {
        System.out.println(new Code122买卖股票问题2().maxProfit(new int[]{7, 1, 5, 3, 6, 4}));
        System.out.println(new Code122买卖股票问题2().maxProfit20211205(new int[]{7, 1, 5, 3, 6, 4}));
    }
